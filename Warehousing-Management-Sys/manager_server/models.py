...
class Monitor(models.Model):
    M_ID = models.CharField(max_length=128, primary_key=True)
...
class Saler(models.Model):
    S_ID = models.CharField(max_length=128, primary_key=True)
...
class PurchasingAgent(models.Model):
    PA_ID = models.CharField(max_length=128, primary_key=True)
...
class Supervise(models.Model):
    M_ID = models.CharField(max_length= 128)
    W_ID = models.CharField(max_length= 128, primary_key=True)
...
class hottest(models.Model):
    CommodityName = models.CharField(max_length=128,primary_key=True)
    Quantity = models.IntegerField
...
class totalearn(models.Model):
    tearn = models.IntegerField(primary_key=True)
...
class totalcost(models.Model):
    tcost = models.IntegerField(primary_key=True)
